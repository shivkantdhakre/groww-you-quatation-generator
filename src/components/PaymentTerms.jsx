  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
      ...
      <div className="mt-6 pt-5 border-t border-slate-100">
        <label className="block text-xs font-semibold text-slate-600 mb-1">Terms & Conditions (Notes)</label>
        <textarea
          className="w-full px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-groww-orange min-h-[100px]"
          placeholder="1. Validity: 15 Days&#10;2. Taxes: 18% GST Extra"
          {...register('meta.paymentNotes')}
        />
      </div>
